...
1. **Owned** Uber's **FRM Risk Scoping backend (FastAPI, MySQL)** across **30+ REST APIs** powering **8** scoping screens, automating quarterly close at **$340M group materiality**, targeting a **70% cut** in manual reconciliation (**~2 weeks → ~3–4 days**, ESTIMATED baseline; 70% is TDD TARGET).
