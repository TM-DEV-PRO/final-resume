...
**Track:** Final Python + Go + AI · **PDF:** `Tarun_Mittal_SSE_PyGo_AI_Final.pdf` · **Contact:** tm.eng2021@gmail.com · (+91) 9001542418
...
> cloud-native, high-throughput distributed systems using **Python, Go, FastAPI, Gin, Kafka, Flink, Redis, PostgreSQL, ClickHouse, and cloud platforms (AWS, GCP)**. He has a proven track record
...
distributed systems in Python and Go. At Uber, via EPAM, I owned the FRM Risk Scoping backend —
