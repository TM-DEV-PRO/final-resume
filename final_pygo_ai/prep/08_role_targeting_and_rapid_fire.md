...
Same lead stories as `../resume/prep/08_role_targeting_and_rapid_fire.md` — IA ClickHouse/GCS planning store + FastAPI/Go agentic path, Uber Menu streaming, Masters quality/observability, FRM audit correctness.
