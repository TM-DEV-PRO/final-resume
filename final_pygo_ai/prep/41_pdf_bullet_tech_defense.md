...
**PDF name:** `Tarun_Mittal_SSE_5yr.pdf`  
...
| Stack on **this** PDF | **FastAPI**. Never say Go or Spring for Masters on this PDF |
...
| S2 | **Python and Go** microservices; **AI-assisted** + **RAG** | Go=IA edge; Python=IA agents + Menu RAG + FastAPI history | Do not invent Spring on this PDF |
...
| Backend | FastAPI/Gin/Django; no Spring on this PDF | Do not say Spring Boot on FRM/Masters for this track |
...
### Uber FRM (via EPAM) — FastAPI on this PDF

| # | Claim | Why | Rejected |
|---|---|---|---|
| F1 | 70% recon 14d→3d; $340M; 19M GL; FastAPI endpoints; L1–L4 | Automate Sheets math into MySQL; PwC work papers | Inventing you were an Uber FTE; quoting 36 Spring Boot endpoints on this PDF |
...
| F3 | Led 3; SQLAlchemy 100% coverage; Bazel; SQL allowlists; SOX 50% delta-variance | SOX needs explainable SQL and coverage | Skipping allowlists |
| Tech | Python, FastAPI, SQLAlchemy, MySQL, pytest, Bazel, Docker | This track’s FRM stack | Spring on **this** FRM line |
...
### Masters GST — FastAPI on this PDF

| # | Claim | Why | Rejected |
|---|---|---|---|
| G1 | p95 1.2s→300ms; 1500+ clients; PHP→FastAPI; 700→4000 rpm; mentored 2 | Strangler/canary; async IRP so workers do not pin | Big-bang rewrite |
...
| Tech | Python, FastAPI, Kafka, PG, Mongo, Redis, ES, Docker, ELK, New Relic, AWS | This track | Spring Boot on **this** PDF |
