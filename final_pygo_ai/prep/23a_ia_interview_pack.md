> Canonical interviewer pack for `Tarun_Mittal_SSE_5yr.pdf` IA bullets (Agentic first, then Core). Project title: **AssortSmart — Senior Software Engineer (Platform & AI)**. Synced Sep 2026. Canonical: `docs/ASSORTSMART_TAB_RESUME.md`. Full Q&A: [`43_ia_bullet_defense.md`](43_ia_bullet_defense.md).
