...
| **36 FastAPI endpoints** · L1–L4 FSLI · quarter-annualization | PDF | 8 screens remain verbal product depth |
...
| Resume number | Tag |
|---|---|
| p95 1.2s→300ms (75%) · 1,500+ · 700→4,000 rpm · 1M+/day · 100K+ · Redis −30% · coverage 35→82% · 98% deploy | HISTORICAL · FastAPI |
