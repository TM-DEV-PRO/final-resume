...
Every major decision on `Tarun_Mittal_SSE_PyGo_AI_Final.pdf` with how / why / alternatives. Canonical: `docs/ASSORTSMART_TAB_RESUME.md`.
...
## Uber FRM
### FastAPI / SQLAlchemy 2.0 + 8-table SOADB + SHA-256 keys
**What:** 36 FastAPI endpoints, 19M GL, L1–L4, optimistic locking.
...
## Masters / GFG
FastAPI strangler + Kafka/PG shard. GFG PHP→Django.\n