# Behavioral / managerial rounds — 10 STAR stories (Final Python + Go + AI)

> The full stack-correct bank for this track is also in [`../../prep/07_behavioral_star_stories.md`](../../prep/07_behavioral_star_stories.md). Outcomes and LP mapping below are identical.
