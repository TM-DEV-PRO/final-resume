...
**Track:** Campaign PyGo XYZ · **PDF:** `Tarun_Mittal_SSE_PyGo_XYZ.pdf`
...
Stack on this track: FRM = **FastAPI / MySQL** · writes = **Go / Gin** · agent = **Python FastAPI + LangGraph** · Masters = **FastAPI strangler**.

Full answers live in [`../behavioral/star_bank.md`](../behavioral/star_bank.md) and
...
**Masters India**  
FastAPI strangler; Kafka IRP 1M+/day; p95 1.2s→300ms; 700→4,000 req/min; 1,500+ clients; mentored 2; ELK/New Relic triage ~70% faster HISTORICAL.
