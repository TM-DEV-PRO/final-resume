...
**Track:** Campaign PyGo XYZ · **PDF:** `Tarun_Mittal_SSE_PyGo_XYZ.pdf` · **Stack on this track:** Python/FastAPI · Go/Gin
...
**Companion files:**
- Full 10 STAR stories: [`star_bank.md`](../behavioral/star_bank.md)
...
- Company LP guides: [`company_behavior_guides.md`](../behavioral/company_behavior_guides.md)
...
Story numbers = the bank in `../behavioral/star_bank.md`.
