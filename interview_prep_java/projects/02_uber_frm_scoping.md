...
> Same domain and metrics as `../interview_prep_v2/11_uber_frm_deep_dive.md`. Stack reframed to Spring Boot + JPA/Hibernate. Live implementation is FastAPI + SQLAlchemy 2.0; say that if pressed.
