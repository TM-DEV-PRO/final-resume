...
| Clustering module: grounding, ~100-candidate batch, top 3 with evidence | **Committed design** (HLR v1.1 + CH DDL model v1.2, in build) — say "the module in build, per our HLR and DDL model" | §3d; HLR-AG-001/002/003, HLR-SC-001; DDL v1.2 §1 |
