...
TRACKS = [
    ...
    dict(
        ...
        company_guides=None,
        star="07_behavioral_star_stories.md",
        why="./38_why_hire_tarun_qa.md",
    ),
    dict(
        d="resume_java/prep",
        label="Java/Spring (source)",
        langs="Java and Python",
        stack_short="Java/Spring · Python",
        frm="Spring Boot / MySQL",
        writes="Spring Boot",
    ...
    dict(
        d="campaign_pygo_xyz/interview_prep",
        label="Campaign PyGo XYZ",
        langs="Python and Go",
        stack_short="Python/FastAPI · Go/Gin",
        frm="FastAPI / MySQL",
        writes="Go / Gin",
        ...
        company_guides="../behavioral/company_behavior_guides.md",
        star="../behavioral/star_bank.md",
        star_link="../behavioral/star_bank.md",
        why="./38_why_hire_tarun_qa.md",
    ),
    dict(
        d="resume/prep",
        label="Python/Go (legacy)",
        langs="Python and Go",
        stack_short="Python/FastAPI · Go/Gin",
        frm="FastAPI / MySQL",
        writes="Go / Gin",
