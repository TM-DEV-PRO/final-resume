...
build(
    ...
    + [
        ...
        os.path.join(FJ_PREP, "38_why_hire_tarun_qa.md"),
        os.path.join(FJ_PREP, "41_pdf_bullet_tech_defense.md"),
        os.path.join(FJ_PREP, "42_clickhouse_rollup_migration.md"),
        os.path.join(FJ_PREP, "43_ia_bullet_defense.md"),
...
build(
    ...
    + [
        ...
        os.path.join(FJPI_PREP, "38_why_hire_tarun_qa.md"),
        os.path.join(FJPI_PREP, "41_pdf_bullet_tech_defense.md"),
        os.path.join(FJPI_PREP, "42_clickhouse_rollup_migration.md"),
        os.path.join(FJPI_PREP, "43_ia_bullet_defense.md"),
...
build(
    [
        ...
        os.path.join(FP_PREP, "38_why_hire_tarun_qa.md"),
        os.path.join(FP_PREP, "41_pdf_bullet_tech_defense.md"),
        os.path.join(FP_PREP, "42_clickhouse_rollup_migration.md"),
        os.path.join(FP_PREP, "43_ia_bullet_defense.md"),
