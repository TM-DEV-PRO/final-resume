...
- Defenses for LangGraph/RAG/MCP: same depth as main `../../resume/prep/agentic_assort_playbook/05_tech_deep_dives.md`.
...
Same depth as main `../../resume/prep/06_tech_deep_dives.md` §§3–6 (now includes ESTIMATED rates). Flink/Spark jobs are often Java/Scala at Uber; this resume's Menu **Tech Used** line stays Python + streaming (matches live stack) — do not invent a Spring control-plane bullet you cannot defend.
