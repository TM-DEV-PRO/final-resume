...
Aligned to **Final Java + AI** resume (`Tarun_Mittal_SSE_Java_AI_Final.pdf`). Paste-ready. Avoid colon-heavy AI voice in About.

## Headline (pick one)
1. Senior Software Engineer | Java · Python | Distributed Systems · Kafka · ClickHouse · LangGraph
2. Backend SSE (Java and Python) | Uber (via EPAM) FRM · Kafka 1M+/day · Go/Gin AssortSmart · LangGraph
...
## Featured section
- Resume PDF (Java FRM + AssortSmart platform/AI)
- LangChain Academy cert
- HackerRank Problem Solving cert
- Optional: GitHub TM-DEV-PRO

## Skills order (LinkedIn)
Java · Spring Boot · Hibernate · Python · Distributed Systems · Microservices · Kafka · ClickHouse · System Design · Docker · AWS · GCP · PostgreSQL · MySQL · Redis · LangGraph · RAG · Mentorship\n