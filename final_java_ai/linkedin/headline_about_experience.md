...
Aligned to **Final Java + AI** resume. Paste-ready. Avoid colon-heavy AI voice in About where possible.

## Headline (pick one)
1. Senior Software Engineer | Java · Python | Distributed Systems · Kafka · AI-assisted systems
2. Backend SSE (Java and Python) | Owned Uber (via EPAM) FRM design · Kafka 1M+/day · LangGraph + ClickHouse
...
## About — long
I am a Senior Software Engineer focused on backend and data platforms in Java and Python.
...
- AI-assisted planning at Impact Analytics: AssortSmart Keep/Drop engine and dig-deeper QnA (Python, LangGraph, MCP) with Spring Boot write plane and a measured ClickHouse 250M pivot POC (from 189s to 12.3s, about 15.5x).
