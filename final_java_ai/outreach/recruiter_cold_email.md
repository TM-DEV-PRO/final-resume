...
- Referral-ready Senior SWE (Java · Python) [Company] [Req ID]

## Email body (long)
Hi [Name]

I am Tarun Mittal, a Senior Software Engineer (Java and Python) with 5 years owning production backends and applied-AI systems. Quick proof points from the resume:
...
## LinkedIn DM short
Hi [Name] Senior SWE Java/Spring 5y. Owned Uber FRM (36 endpoints, led 3) Kafka 1M+/day and now AssortSmart Go/Gin 10k RPS + LangGraph Keep/Drop. Open to [Role]? Can send resume.

## LinkedIn DM long
Hi [Name] — hire-for-fit in one glance: Uber (via EPAM) FRM owner (36 Spring Boot endpoints, 70% 14d→3d, led 3) + Menu E2E ($600K/yr, 24h→2h, Kafka/Flink) + Masters Kafka 1M+/day + current AssortSmart Go/Gin 10k RPS, ClickHouse 2.11B, and shipped Ask Iris. Looking at [Company] senior backend / applied-AI roles. If you are sourcing for [Team] I would love a quick screen. Resume here: [link].\n