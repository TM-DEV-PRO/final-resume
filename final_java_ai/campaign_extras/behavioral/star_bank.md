# Behavioral / managerial rounds — 10 STAR stories (Final Java + AI)

> For this track's stack-correct wording per story (Spring Boot / JUnit / Hibernate; agent plane in Python), see [`../../prep/07_behavioral_star_stories.md`](../../prep/07_behavioral_star_stories.md). Outcomes and LP mapping below are identical.
