...
Backs this track (PDF: `Tarun_Mittal_SSE_Java_AI_Final.pdf`). Canonical claims: [`docs/ASSORTSMART_TAB_RESUME.md`](../../docs/ASSORTSMART_TAB_RESUME.md).

**Summary on the PDF:** 5 years architecting high-throughput cloud-native distributed systems and leading zero-downtime migrations · Expert in **Java and Python microservices** · LangGraph multi-agent systems, Milvus RAG, deterministic eval harnesses.
