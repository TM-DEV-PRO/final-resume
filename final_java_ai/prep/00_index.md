...
**Summary on the PDF:** 5 years designing and owning cloud-native high-throughput **distributed systems** · Expertise in **Java and Python** microservices with **AI-assisted** and **RAG** · shipping systems, backend migrations, reliability.
