...
**Resume tech:** Python, LangGraph, MCP · write plane **Spring Boot** · ClickHouse · BigQuery · GCS · Datadog · LangSmith · PostHog · Docker  
