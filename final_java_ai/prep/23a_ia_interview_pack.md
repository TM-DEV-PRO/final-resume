> Canonical interviewer pack for `Tarun_Mittal_SSE_Java_AI_Final.pdf` IA bullets (Platform + Agentic). Project title: **AssortSmart — Senior Software Engineer (Platform & AI)**. Synced Sep 2026. Canonical: `docs/ASSORTSMART_TAB_RESUME.md`.
