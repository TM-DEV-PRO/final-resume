...
| S2 | Expertise in Java and Python microservices, with applied experience in AI-assisted and RAG systems. | `36_skills_ai_agents_defense.md` · `campaign_extras/.../skills_fundamentals_map.md` | framing |
...
| Masters* | Spring Boot strangler p95 from 1.2s to 300ms Kafka 1M+/day mentored 2 | `12_masters_gfg_deep_dive.md` · `23c` | HISTORICAL |
