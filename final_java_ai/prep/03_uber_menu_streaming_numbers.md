...
1. [`../resume/prep/projects/03_uber_menu_ingestion.md`](projects/03_uber_menu_ingestion.md) §3–4 (why Kafka/Flink/Spark/Pinot **with numbers**)
2. [`../resume/prep/06_tech_deep_dives.md`](06_tech_deep_dives.md) §§3–6
