...
Use this when applying with this track — `final_java_ai/artifacts/Tarun_Mittal_SSE_5yr_Java_AI.pdf`. Lead with Java/Spring keywords; keep cloud, Kafka, and systems stories.
