...
Aligned to **Final Java + AI** (`Tarun_Mittal_SSE_5yr_Java_AI.pdf`). Canonical: `docs/ASSORTSMART_TAB_RESUME.md`.

## One-liners
- **Headline fit:** Senior SWE Java · Python · Go/Gin 10k RPS · ClickHouse 2.11B · 36 Spring Boot endpoints · Kafka 1M+/day · LangGraph Ask Iris
...
## Attach
`artifacts/Tarun_Mittal_SSE_5yr_Java_AI.pdf`
