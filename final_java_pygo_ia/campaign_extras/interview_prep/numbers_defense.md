...
Interview sheet for `Tarun_Mittal_SSE_5yr_Java_PyGo_AI.pdf`. Canonical: `docs/ASSORTSMART_TAB_RESUME.md`. Cross-links: `../../prep/GROUND_TRUTH.md`, `../../prep/18_resume_number_catalog.md`.

## Impact Analytics (PDF)

| Resume number | Tag | Defense |
|---|---|---|
...
**Do NOT** put projected 12B on the PDF. **Do NOT** claim IA Kafka/Flink/K8s-ops.

## Uber FRM

| 70% · 14d→3d · $340M · 19M GL · 36 Spring Boot endpoints · L1–L4 · 8-table SOADB · SHA-256 · led 3 · 100% · SOX 50% | PDF |

## Uber Menu / ANZ / Masters / GFG

Same as `../../prep/18_resume_number_catalog.md`. Menu 98% = offline. ANZ = HISTORICAL Mobility. Spark not on PDF.\n