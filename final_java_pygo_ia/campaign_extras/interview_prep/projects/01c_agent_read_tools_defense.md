...
> Defend the live resume from `docs/ASSORTSMART_TAB_RESUME.md` (Platform + Agentic: 10k RPS, CH 189s to 12s / six tables / 170 GB OOM, Ask Iris shipped, 300-case / 80% promotion gate).
