...
Aligned to **Final Java + AI (IA = Py/Go)** (`Tarun_Mittal_SSE_5yr_Java_PyGo_AI.pdf`). Paste-ready. Adapted from the AssortSmart-tab packet templates; claims match the **current PDF**, not packet overclaims (no K8s-ops, no IA Flink/CDC).
