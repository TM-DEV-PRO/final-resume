...
|---|---|---|---|---|---|
| Ownership / end-to-end | Arch owner; writes=Go / Gin; agent=Python FastAPI + LangGraph; CH POC 189s→12.3s MEASURED | 30+ APIs, 8 screens, $340M, led 3 | Selenium→Kafka→Flink→RAG gate; 24h→2h; $600K+/yr | Spring Boot strangler; 1M+/day; mentored 2 | Django reliability |
