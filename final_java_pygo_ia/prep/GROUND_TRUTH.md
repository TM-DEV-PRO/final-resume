...
**PDF:** `Tarun_Mittal_SSE_Java_PyGoIA_Final.pdf` · Project title: **AssortSmart (Retail Merchandise Planning Platform)**
...
**Stack on this track:** agent plane = FastAPI, LangGraph, MCP; write plane = Go / Gin. Same as final_java_ai for Uber FRM/Menu/Masters/GFG (Java/Spring). IA difference: AssortSmart write APIs = Go / Gin. Project title on PDF: AssortSmart (Retail Merchandise Planning Platform).
...
- IA: Same as final_java_ai for Uber FRM/Menu/Masters/GFG (Java/Spring). IA difference: AssortSmart write APIs = Go / Gin. Project title on PDF: AssortSmart (Retail Merchandise Planning Platform).
