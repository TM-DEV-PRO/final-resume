...
**Track:** Final Java + AI (IA = Py/Go) · **PDF:** `Tarun_Mittal_SSE_Java_PyGoIA_Final.pdf` · **Contact:** tm.eng2021@gmail.com · (+91) 9001542418
...
> cloud-native, high-throughput distributed systems using **Java, Python, Go, Spring Boot, FastAPI, Gin, Kafka, Flink, Redis, PostgreSQL, ClickHouse, and cloud platforms (AWS, GCP)**. He has a proven track record
...
cloud-native distributed systems in Java, Python and Go. I've owned finance-grade services at Uber, scaled a
...
distributed systems in Java, Python and Go. At Uber, via EPAM, I owned the FRM Risk Scoping backend —
