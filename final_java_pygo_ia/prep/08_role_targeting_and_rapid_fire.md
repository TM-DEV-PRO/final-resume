...
Use this when applying with this track — `final_java_pygo_ia/artifacts/Tarun_Mittal_SSE_5yr_Java_PyGo_AI.pdf` (the primary public resume). Lead with Java/Spring keywords for Uber and Masters; the AssortSmart write plane is Go/Gin and the AI path is Python.
