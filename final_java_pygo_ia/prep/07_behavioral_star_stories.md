...
Outcomes, leadership signals, and story structure are **identical** to `../../resume/prep/07_behavioral_star_stories.md`. Use that file as the canonical bank (10 stories). Below are **stack wording swaps** so you don't say FastAPI/Gin/pytest when interviewing on the Java resume.
...
| 8. Masters India migration | Deadline pressure; p95 **1.2s→300ms**; **700→4,000 req/min**; **1,500+** clients | Spring Boot strangler; Spring Batch bulk; Kafka + PG quarter sharding |
