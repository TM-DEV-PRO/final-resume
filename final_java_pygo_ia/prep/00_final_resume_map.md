# Final Java + AI (IA = Py/Go) — every PDF point → deep defense
...
| S2 | Expert in Java, Python and Go microservices; event-driven pipelines; multi-billion-row DBs; extreme latency cuts | `36_skills_ai_agents_defense.md` | framing |
