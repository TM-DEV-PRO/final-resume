...
- **MongoDB, Elasticsearch** — Masters India + GeeksforGeeks (see `02_mongodb_elasticsearch.md`)
- **BigQuery** — ingest source of truth (defend carefully)
- **SSE** — agent progress streaming (IA)
- **Kafka** — IA async jobs + Uber Menu bus
- **Kubernetes** — ops literacy next to ELK/New Relic ownership story
