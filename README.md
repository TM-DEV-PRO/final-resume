...
- **Java track (`resume_java/`):** same projects/metrics; primary stack Java · Spring Boot · Hibernate/JPA · Spring Security/Batch/WebFlux · Spring AI/LangChain4j; cloud + Kafka/Flink/Spark/Pinot/ClickHouse unchanged.
